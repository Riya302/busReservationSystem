...
<body>
  <div data-ng-controller="HomeController">
	<div class="container-fluid mt-3 bg-dark"> 
		 <div class="d-flex justify-content-center">
			  ...
			  <button type="submit" data-target="#bussearch" data-toggle="pill" ng-click="fetchbusdetails()"><i class="fa fa-search" id="search1" color="	#FA8072"></i></button>
		 </div>
	</div>
	
	<div class="container-fluid mt-3 bg-info">
	   <div class="btn-group-lg">
	    <button type="button" class="btn btn-info" data-target="#busregistration" data-toggle="pill" color="	#FA8072">Bus Registration</button>
	    <button type="button" class="btn btn-info" data-target="#customerseatbooking" data-toggle="pill" color="	#FA8072">Customer Seat Booking</button>
	   </div>
    </div>
 ...
 <button type="button" data-toggle="modal" data-target="#myModal" id="id1" ng-show="false" color="	#FA8072">Alert</button>
